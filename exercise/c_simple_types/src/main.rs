...
// LEARNING LESSON
// I forst got an 'E0432' error of unresolved import
// This is because the name of the project in the Cargo.toml file was named 'ding_machine'
// In order to resolve the error, I changed the name of the project to be 'c_simple_types'
...
fn main() {
    ...
    //
    let coords_arr = [x, y]; // create an array literal out of parts of `coord` here
